 ...
 */
final class Version20210310134504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, telephone INT NOT NULL, adress VARCHAR(255) DEFAULT NULL, date_birth VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, bio LONGTEXT DEFAULT NULL, prenom VARCHAR(255) NOT NULL, genre INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE formation DROP FOREIGN KEY FK_404021BF19EB6921');
        $this->addSql('ALTER TABLE langue DROP FOREIGN KEY FK_9357758E19EB6921');
        $this->addSql('ALTER TABLE loisir DROP FOREIGN KEY FK_CF3B206019EB6921');
